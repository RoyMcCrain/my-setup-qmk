 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LGUI | BACK |  VIM | /Space  /       \Enter \  |RCTLE |RAISE |TENKEY|
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | LAlt |      |RWORD |END   |      |TAB   |                    |YANK  |UNDO  |      |      |PASTE |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |AHEAD |      |CUT   |      |      |-------.    ,-------|  ←  |  ↓  |  ↑  |  →  |      |      |
 * |------+------+------+------+------+------|   (   |    |    )  |------+------+------+------+------+------|
 * |      |      |BSPC  |      |      |LWORD |-------|    |-------|      |      |      |      |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |LOWER | /Space  /       \CmdEnt\  |RAISE |BackSP| RGUI |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
[_LOWER] = LAYOUT( \
...
[_RAISE] = LAYOUT( \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
  _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                    XXXXXXX, KC_CIRC, KC_AMPR, KC_ASTR, XXXXXXX, _______, \
  _______, KC_GRV,  KC_BSLS, KC_EQL,  KC_QUOT, KC_MINUS,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,KC_UNDS, _______, \
  _______, KC_UNDO, KC_CUT,  KC_COPY, KC_PASTE,XXXXXXX,  KC_LBRC, KC_RBRC, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, \
                             XXXXXXX, KC_DEL,  XXXXXXX,  KC_TAB,  XXXXXXX, XXXXXXX, _______, _______ \
),
