 ...
 * |   ;  |   Q  |   J  |   K  |   X  |      |      |   B  |   M  |   W  |   V  |   Z  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | GUI  | Alt  | Ctrl |Lower |Space |      |      | ENT  | Raise| BCSP |SHIFT | Save |
 * `-----------------------------------------------------------------------------------'
 */
[_DVORAK] = LAYOUT_planck_grid(
    KC_QUOT, KC_COMM, KC_DOT,  KC_P,    KC_Y,   KC_TAB,  KC_BSPC,     KC_F,    KC_G,    KC_C,    KC_R,    KC_L,
    KC_A,    KC_O,    KC_E,    KC_U,    KC_I,   KC_UP,   KC_DOWN,     KC_D,    KC_H,    KC_T,    KC_N,    KC_S,
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    UNDO,    CUT,     COPY,    PSTE,    KC_LPRN, _______, _______, KC_RPRN, KC_MINUS, KC_DOT,  KC_ASTR, KC_PLUS,
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    UNDO,    CUT,     COPY,    PSTE,    KC_LBRC,  _______, _______, KC_RBRC, KC_MINUS, KC_DOT,  KC_ASTR, KC_PLUS,
 ...
 * |       |      |      |      |      |      |      |      |      |  ↑  |      |      |
 * |-------+------+------+------+------+------+------+------+------+------+------+------|
 * |CK_TOGG|MU_MOD|MU_TOG|AU_TOG|      |      |      |      |  ←  |CLICK |  →  |RESET |
 * |-------+------+------+------+------+------+------+------+------+------+------+------|
 * |       |      |      |      |      |      |      |      |      |  ↓  |      |      |
 * |-------+------+------+------+------+------+------+------+------+------+------+------|
 * |       |      |      |      |      |      |      |      |CLICK2|      |      |      |
...
[_ADJUST] = LAYOUT_planck_grid(
    _______, _______, _______, _______, _______, _______, _______, _______, _______,  KC_MS_U, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_MS_L,  KC_BTN1, KC_MS_R, RESET,
    _______, _______, _______, _______, _______, _______, _______, _______, _______,  KC_MS_D, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_BTN2,  _______, _______, _______
)
